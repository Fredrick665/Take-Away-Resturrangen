...
function CartListItem({ name, price, quantity, onAdd, onSubtract, notes, onNotesChange }: CartListItemProps) {
    return (
        <section className='product-item'>
            ...
            <div className="btn-quantity">
                <button className='btn-subtract' onClick={onSubtract}>-</button>
